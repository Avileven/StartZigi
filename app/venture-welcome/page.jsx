  ...
  useEffect(() => {
    const createWelcomeMessages = async (venture) => {
      ...
      await VentureMessage.create({
        ...
        title: '📋 Welcome to The Plan phase!',
        content: `You've now entered the Plan & Foundation phase! Time to build a solid foundation for "${venture.name}". Complete all 10 sections of your plan to unlock the next phase and start building your MVP. Focus on defining your target market, competition analysis, and revenue model.`,
        phase: 'business_plan',
        priority: 2
      });
    };
