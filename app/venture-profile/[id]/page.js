...
export default async function VentureProfilePoC({ params }) {
  ...
  // Fetch data directly from business_plans
      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="bg-gray-50 rounded-2xl border border-gray-200 p-8 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
            ...
            <div className="p-4 bg-white rounded-xl border border-gray-100 shadow-sm">
              <p className="text-sm text-purple-600 font-bold mb-1">Reference ID</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <section className="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm">
              ...
              <div className="text-gray-700 whitespace-pre-wrap bg-orange-50/20 p-6 rounded-lg border border-orange-100 text-sm leading-relaxed font-mono">
            ...
            <section className="bg-white p-6 rounded-2xl border border-gray-200 shadow-sm">
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-gray-700 mt-1 text-sm leading-relaxed">{plan.revenue_model}</p>
                </div>
              </div>
            </section>
