// v 020226 with how-it-work link
"use client";
  ...
  {isMenuOpen && (
    <div className="md:hidden bg-gray-900 border-b border-white/10 px-4 pt-2 pb-6 space-y-2">
      ...
      <div className="relative isolate overflow-hidden bg-gradient-to-br from-indigo-600 to-purple-800 min-h-screen flex items-center justify-center">
        <AnimatedBg />
        <div
  className="mt-10 flex flex-col sm:flex-row items-center justify-center gap-4 animate-slideUp w-full max-w-md mx-auto sm:max-w-none px-4"
...
>
  {user ? (
    hasVenture ? (
      <Link href="/dashboard" className="w-full sm:w-auto">
        <Button
          size="lg"
          className="bg-indigo-500 text-white hover:bg-indigo-600 shadow-lg w-full sm:w-auto"
        >
  ...
  <a href="/how-it-works.html" target="_blank" className="w-full sm:w-auto">
    <Button
      size="lg"
      variant="outline"
      className="bg-white/10 text-white border-white/30 hover:bg-white/20 backdrop-blur-sm shadow-lg w-full sm:w-auto"
    >
