    ...
    <div className="min-h-screen bg-white text-gray-900">
      ...
      <main className="max-w-[1400px] mx-auto px-[10%] py-12 grid grid-cols-1 md:grid-cols-[240px_1fr] gap-12">
        ...
        <aside className="sticky top-24 h-fit">
          <nav>
            <ul className="space-y-1 border-r border-gray-200">
              {categories.map(cat => (
                <li
                  key={cat.id}
        ...
        <section className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8">
          {filteredArticles.map((article, i) => (
            ...
            >
              {/* Card header — text on gradient instead of image */}
      ...
      {openArticle && (
        ...
        >
          <div
            className="bg-white border border-gray-200 rounded-2xl max-w-2xl w-full max-h-[80vh] overflow-y-auto shadow-2xl"
          ...
          >
            ...
            <div className="px-8 pb-8">
              <button
                onClick={() => setOpenArticle(null)}
                className="text-sm text-gray-500 hover:text-gray-700 border border-gray-300 hover:border-gray-500 px-5 py-2 rounded-full transition-all"
              >
                Close
              </button>
            </div>
