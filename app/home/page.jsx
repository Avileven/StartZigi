      ...
      <div className="relative isolate overflow-hidden bg-gradient-to-br from-indigo-600 to-purple-800 min-h-screen flex items-center justify-center">
        ...
        <div className="relative text-center z-10 p-4">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-300 animate-slideUp" style={{ animationDelay: '0.2s' }}>
              Read about a big tech exit lately and thought, “I want to try that”?  
              StartZig is your entrepreneurial simulation platform — test ideas, build real ventures, and experience the startup journey without real-world risk.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            ...
            <p className="mt-2 text-3xl font-bold tracking-tight text-white sm:text-4xl">
              From curiosity to company — one guided journey
            </p>
            <p className="mt-6 text-lg leading-8 text-gray-300">
              StartZig walks you through every stage of entrepreneurship: validate ideas, build business plans, launch MVPs, attract investors, and grow — all inside a realistic simulation.
            </p>
          </div>
        </div>
      </div>
      ...
      <div id="benefits" className="bg-gray-800/50 py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mx-auto max-w-2xl lg:text-center">
            ...
            <p className="mt-6 text-lg leading-8 text-gray-300">
              Whether you’re here to play, learn, or prepare for the real world — StartZig gives you a professional environment to experiment, improve, and grow.
            </p>
          </div>
        </div>
      </div>
