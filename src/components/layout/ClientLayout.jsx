  ...
  return (
    <SidebarProvider>
      <div className="min-h-screen flex w-full bg-gray-50">
        <Sidebar className="border-r border-gray-200 z-[100]">
        ...
        <main className="flex-1 flex flex-col">
          <header className="bg-white border-b border-gray-200 px-4 py-3 md:hidden">
            <div className="flex items-center justify-center gap-3">
              <div className="flex items-center gap-2 bg-indigo-600 text-white text-sm font-medium px-1 py-2 rounded-lg">
                <SidebarTrigger className="text-white hover:bg-indigo-700 p-1 rounded" />
                <span className="pr-2">Navigation</span>
              </div>
              <button
                className="flex items-center gap-2 bg-indigo-600 text-white text-sm font-medium px-3 py-2 rounded-lg hover:bg-indigo-700"
