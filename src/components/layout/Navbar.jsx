        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex-shrink-0">
            <Link href="/" className="flex items-center gap-2">
              <svg version="1.0" xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="750 750 520 520" preserveAspectRatio="xMidYMid meet">
                <defs>
